...
<a name="rpc_index_Istio"></a>
## Service: Istio
The Service name `Istio` is needed to create RPC client stubs.

<a name="rpc_index_istio.mixer.v1.Mixer"></a>
## [istio.mixer.v1.Mixer](#istio.mixer.v1.Mixer)
[Check](#istio.mixer.v1.Mixer.Check)
Checks preconditions before performing an operation.
[Quota](#istio.mixer.v1.Mixer.Quota)
Quota allocates and releases quota.
[Report](#istio.mixer.v1.Mixer.Report)
Reports telemetry, such as logs and metrics.

<a name="_api_reference"></a>
# Reference
